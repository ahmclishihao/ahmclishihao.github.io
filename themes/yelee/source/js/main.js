require([], function (){
	...
	var overlayColor = "#455A64"
    // PC
    $("#container .left-col .overlay").css({"background-color": overlayColor,"opacity": 1});
    // Mobile
    $("#container #mobile-nav .overlay").css({"background-color": overlayColor,"opacity": 1});
